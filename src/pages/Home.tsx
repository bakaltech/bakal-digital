      ...
      <section className="py-24 md:py-48 bg-paper">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mb-16 md:mb-24">
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-accent mb-6">What We Build</p>
            <h2 className="text-4xl md:text-6xl font-semibold text-ink leading-tight tracking-tight mb-8">
              Digital products, systems, and experiences designed to move the business forward.
            </h2>
            <p className="text-xl text-brand-400 leading-relaxed max-w-3xl">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-16 md:gap-32 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}>
              <p className="text-sm font-bold uppercase tracking-[0.3em] text-accent mb-8">How We Think</p>
      ...
      <section className="py-24 md:py-48 bg-ink relative overflow-hidden text-center md:text-left">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <Link to="/contact" className="inline-flex items-center justify-center px-10 py-5 md:px-12 md:py-6 text-lg md:text-xl font-medium rounded-full text-ink bg-white hover:bg-accent hover:text-white transition-all shadow-2xl">
              Start a Project
