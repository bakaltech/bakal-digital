...
export default function InteractiveHero() {
  ...
  return (
    <section className="relative min-h-[700px] sm:min-h-[820px] md:min-h-[900px] w-full overflow-hidden bg-paper flex items-center justify-center pt-24 sm:pt-32 md:pt-36 pb-10 sm:pb-14">
      <div className="absolute inset-0 z-0 opacity-0 md:opacity-42 pointer-events-none scale-105 md:scale-110 rotate-[-3deg] md:rotate-[-6deg]">
      ...
      <div className="absolute inset-0 z-[5] bg-gradient-to-b from-paper/75 via-paper/92 to-paper/55 md:from-paper/42 md:via-paper/74 md:to-paper/38 backdrop-blur-[3px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full flex flex-col items-center">
        <motion.div
          ...
          className="glass px-5 py-8 sm:px-8 sm:py-10 md:px-12 md:py-14 rounded-[2rem] sm:rounded-[3rem] shadow-2xl max-w-[64rem] w-full text-center relative overflow-hidden"
        >
          ...
          <p className="text-[11px] sm:text-xs text-brand-400 font-bold tracking-[0.24em] sm:tracking-[0.35em] uppercase opacity-80 mb-5 sm:mb-7">
            AI Products | Custom Platforms | Automation | Data Systems
          </p>

          <h1 className="text-[clamp(2.35rem,10vw,5.8rem)] font-bold text-ink leading-[0.96] tracking-tight mb-5 sm:mb-8 max-w-[12ch] mx-auto">
            We build the digital systems <br />
            <span className="block mt-2 text-[clamp(1.5rem,6vw,3rem)] text-brand-300 italic serif leading-[1.05]">
              modern businesses grow on.
            </span>
          </h1>

          <p className="text-base sm:text-[1.1rem] md:text-[1.25rem] text-brand-400 font-normal leading-relaxed mb-7 sm:mb-9 max-w-[38rem] mx-auto">
          ...
          <p className="hidden sm:block mt-7 sm:mt-9 text-[10px] sm:text-xs text-brand-400 font-bold tracking-[0.24em] sm:tracking-[0.3em] uppercase opacity-60">
